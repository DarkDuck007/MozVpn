...
namespace MozVPNMaui2.Platforms.Android
{
   [Service(Exported = false,
          ForegroundServiceType = ForegroundService.TypeDataSync | ForegroundService.TypeConnectedDevice)]
   internal class MozProxyService : Service
   {
      ...
      private void startForegroundService()
      {
         ...
         StartForeground(NOTIFICATION_ID, notification.Build(),ForegroundService.TypeDataSync|ForegroundService.TypeConnectedDevice);
